function [best_model_BIC,BIC_best,best_model_nll,nll_best] = master_function(start_vals,file_name,fid_BIC,fid_unix_params,fid_uniy_params,fid_GLC_params,fid_responses_accounted)
