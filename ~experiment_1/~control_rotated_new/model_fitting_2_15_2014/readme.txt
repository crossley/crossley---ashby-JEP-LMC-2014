**** ReadMe file for Ashby Lab 2D stimuli data analysis package ****

This package of files contains model fitting programs for 2 dimensional stimuli.  The package contains the following rule types:
...
"data_analysis_gui" launches the gui that allows more detailed, graphical based analysis of the data set.  Using the gui, the user can visually
	inspect the best fitting bounds that each model fit yields.  The user can also visually inspect the data set, independent of any model fitting.
	
	VERY IMPORTANT - The "data_analysis_gui" expects "transform_data" to have been run.  In other words, the "data_analysis_gui" will only 
	operate on the transformed data.
